...
const Install = () => {
  return (
    <div>
      <section className="text-blue-500 bg-black body-font">
      <h1 className="text-center text-5xl ubuntu-bold">How It Works?</h1>
        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap">
          <div className="flex flex-wrap w-full">
            <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
              ...
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed">Coloring book narwhal glossier master cleanse umami. Salvia +1 master cleanse blog taiyaki.</p>
                </div>
              </div>
              <div className="flex relative pb-12">
                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
            ...
            <img className="lg:w-3/5 md:w-1/2 object-fit object-center rounded-lg md:mt-0 mt-12" src="bit3.png" alt="step" />
          </div>
        </div>
      </section>
    </div>
